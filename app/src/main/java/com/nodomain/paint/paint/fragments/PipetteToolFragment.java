...
public class PipetteToolFragment extends BaseToolFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public static PipetteToolFragment newInstance(int color) {
        PipetteToolFragment fragment = new PipetteToolFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tool_pipette, container, false);
        initViews(view);
        return view;
    }
