...
public class LineToolFragment extends BaseToolFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public static LineToolFragment newInstance(int color, int size) {
        LineToolFragment fragment = new LineToolFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tool_line, container, false);
        initViews(view);
        return view;
    }
