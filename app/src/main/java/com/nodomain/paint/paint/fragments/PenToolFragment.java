...
public class PenToolFragment extends BaseToolFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public static PenToolFragment newInstance(int color) {
        PenToolFragment fragment = new PenToolFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tool_pen, container, false);
        initViews(view);
        return view;
    }
